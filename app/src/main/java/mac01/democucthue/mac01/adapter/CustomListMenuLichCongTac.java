...
/**
 * Created by mac01 on 5/11/17.
 */

public class CustomListMenuLichCongTac extends BaseAdapter{
    String [] result;
    Context context;
    int [] imageId;
    private static LayoutInflater inflater=null;
    public CustomListMenuLichCongTac(LichCongTacActivity mainActivity, String[] prgmNameList, int[] prgmImages) {
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        // TODO Auto-generated method stub
        CustomListMenuLichCongTac.Holder holder=new CustomListMenuLichCongTac.Holder();
        View rowView;
